...
{
    public class HomeBase : ObjectRepository
    {  

        public static int timeoutWait = 10;

        /// <summary>
        /// Enum that defines Role type
        /// </summary>
        public enum Role
        {
            [DescriptionAttribute("Common")]
            Common = 0,
            [DescriptionAttribute("SchoolTech")]
            SchoolTech = 1,
            [DescriptionAttribute("Teacher")]
            Teacher = 2,
            [DescriptionAttribute("Student")]
            Student = 3,
            [DescriptionAttribute("Parent")]
            Parent = 4,
        ...
        public enum Page
        {
            ...
            ProfilePage = 6,
            [Description("SetPaswordQuestionPage")]
