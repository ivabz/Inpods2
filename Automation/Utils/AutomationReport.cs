    ...
    public class AutomationReport
    {
        ...
        private void CreateHeaderReport(int totalTestCases, int passedTestCases, int failedTestCases, int infoTestCases, int totalSteps, int failedSteps, int passedSteps, int infoSteps, string testRunPath, string serverName)
        {
            ...
            try
            {
                ...
                report = report + "</TD><TD><font size=\"2\" face=\"Calibri\" color=green><STRONG>Server Name  :  <a href=\"https://" + serverName + "/InPods/\"  style=\"text-decoration:none\" target=\"_blank\">" + serverName + "</a></STRONG></font></BR>";
        ...
        private string CreateEmbeddedMailContents(int totalTestCases, int passedTestCases, int failedTestCases, int infoTestCases, string serverName, string testRunPath)
        {
            ...
            try
            {
                ...
                embeddedMailContents = embeddedMailContents + "</TD><TD><font size=\"3\" face=\"Calibri\" color=green><STRONG>Server Name  :  <a href=\"https://" + serverName + "/InPods/\"  style=\"text-decoration:none\" target=\"_blank\">" + serverName + "</a></STRONG></font><br />";
                ...
                //embeddedMailContents = embeddedMailContents + "var options = {title: 'InPods Test Automation Summery',colors:['#2E8B57','#DC143C']};var chart = new google.visualization.PieChart(document.  getElementById('chart_div'));chart.draw(data, options);}</script></head>";
        ...
        private void CreateDashboard(string testRunPath, string totalTestCases,  string passedTestCases, string failedTestCases)
        {
            ...
            try
            {
                ...
                report = report + "var options = {title: 'InPods Test Automation Summery',colors:['#2E8B57','#DC143C'],chartArea:{left:50,top:50,width:\"60%\",height:\"75%\"}};var chart = new google.visualization.PieChart(document.  getElementById('chart_div'));";
