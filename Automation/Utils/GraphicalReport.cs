    ...
    public class GraphicalReport
    {
        ...
        public void GeneratePieGraph()
        {
            try
            {
                ...
                // Generate URL
                string chartUrl = "http://chart.apis.google.com/chart?chs=500x250&cht=p&chco=007800,BD0000&chd=t:" + this.PassedTestCases + "," + this.FailedTestCases + "&chdl=Passed+Test+Cases|Failed+Test+Cases&chl=Passed+" + this.PassedTestCases + "|Failed+" + this.FailedTestCases + "&chtt=InPods+Test+Automation+Summery&chts=675050,11.5";
